...
class Player():
    def __init__(self, surface, sprite, xPos, y_pos):
...
while running:
    # Initialize keys at the start of each frame
    ...
    player.Movement(keys)  # Move player based on current key states
    draw()
    pygame.display.update()
    clock.tick(cSpeed)  # Limit the frame rate